<div class="has-text-centered survey-container" id="survey_ID_PH">
	...
	<div HIDDEN_SURVEY class="image-gallery" id="ID_PH">
		<div class="card surveyInputDiv">
		<input
		type="HIDDEN_1_PH" 
		class="imageCheckbox" 
		name='image_answer' 
		...
		<div HIDDEN_2_PH class="card surveyInputDiv">
		<input  
		type="HIDDEN_2_PH" 
		class="imageCheckbox" 
		name='image_answer' 
		...
		<div HIDDEN_3_PH class="card surveyInputDiv">
		<input   
		type="HIDDEN_3_PH" 
		class="imageCheckbox" 
		name='image_answer' 
		...
		<div HIDDEN_4_PH class="card surveyInputDiv">
		<input   
		type="HIDDEN_4_PH" 
		class="imageCheckbox" 
		name='image_answer' 
...
// 	jQuery('.surveyInputDiv').css({"border":""} );
