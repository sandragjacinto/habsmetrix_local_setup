		...
		<div class="progress-container">
			...
			<div class="progress-flex">
				...
				if(is_user_logged_in()) { ?>
					<input id="submitAll" type="button" class="button title is-7 is-small is-warning" value="submit" style=" cursor: pointer;" onClick=''>
				<?php }else{ ?>
					<input id="notAble2submitAll" type="button" class="button title is-7 is-small is-warning" value="submit" style=" cursor: pointer;" onClick=''>
				<?php } ?>
			</div> <!--progress-flex-->
